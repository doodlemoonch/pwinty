...
Pwinty.prototype = {
    ...
    getCatalogue: function (countryCode, qualityLevel) {
    ...
    deleteOrderPhoto: function (orderId, photoId) {
    ...
    addPhotoToOrder: function (params) {
        ...
        var options = _.extend(this.defaults, {
            url: this.host + 'Orders/' + params.id + '/Photos',
            method: 'POST',
            body: JSON.stringify(params)
        });
    ...
    addPhotosToOrder: function (params) {

        var options = _.extend(this.defaults, {
            url: this.host + 'Orders/' + params[0].id + '/Photos',
            method: 'POST',
            body: JSON.stringify(params)
        });
